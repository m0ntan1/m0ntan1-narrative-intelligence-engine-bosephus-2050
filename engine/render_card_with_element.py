...
# -*- coding: utf-8 -*-
"""
Wide variant of the Bosephus 2050 card: terminal panel on the left, a character
plate on the right, 1600x900.

  python3 render_card_with_element.py <card.json> <element.png> <out.png>

NOT the canonical emit. The canonical card is render_card.py, which is terminal
only. Use this one when a piece is going somewhere that rewards a face, and
accept that the type is smaller because the terminal only gets 720 of the 1600
columns.
